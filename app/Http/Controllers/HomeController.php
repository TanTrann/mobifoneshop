...
class HomeController extends Controller
{
  ...
  public function index(){
	...
	return view('pages.home')->with('all_product', $all_product)->with('all_service',$all_service)->with('cate_product', $cate_product)->with('all_data_service', $all_data_service)->with('all_call_service',$all_call_service)->with('slider',$slider);
   }
