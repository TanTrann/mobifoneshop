                  ...
                  <form action="{{URL::to('save-service')}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-12">
                        <div class="form" style="padding-bottom: 10px">
                          <label for="exampleInputEmail1">Hình ảnh</label>
                              <input type="file" class="form-control" name="service_images">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea rows="8"  name="service_content"  class="form-control" id="ckeditor1" > </textarea>
                        </div>
                      </div>
                   </div>
                    <div class="row">
                      <div class="col-md-2">
                        ...
                        <br>
                                    <select  style="height: 30px ;width: 100px ; padding-left: 10px" name="service_status" input-sm m-bot15> 
