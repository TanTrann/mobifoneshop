                  ...
                  <form action="{{URL::to('save-data-service')}}" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="data_service_name" class="form-control" id="exampleInputEmail1">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Giá tiền</label>
                           <input type="text" name="data_service_price" class="form-control" id="exampleInputEmail1">
                    ...
                    <div class="row">
                      <div class="col-md-2">
                        ...
                        <br>
                                    <select  style="height: 30px ;width: 100px ; padding-left: 10px" name="data_service_status" input-sm m-bot15> 
